...
public static class NetVersion
{
    ...
    /// 4 — ящики, мины и бочки поехали в сверке и объявлениями по номерам
    /// (шаг 15d): у сообщения о ящике сменился формат, и в снимке состояния
    /// появился хвост с предметами.
